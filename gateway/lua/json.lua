...
--
-- copy from: https://github.com/apache/incubator-apisix/blob/master/apisix/core/json.lua
...
local function serialise_obj(data)
    if type(data) == "function" or type(data) == "userdata" or type(data) == "cdata" or type(data) == "table" then
...
local delay_tab =
    ...
    {data = "", force = false},
    {
        __tostring = function(self)
            ...
            if not res then
                ngx.log(ngx.WARN, "failed to encode: ", err, " force: ", self.force)
            end
